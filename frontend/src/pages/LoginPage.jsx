  ...
  return (
    <MainLayout>
      <div className="flex justify-center mt-10 text-black">
        ...
        >
          <h2 className="text-center font-semibold text-3xl mb-3">Sign in</h2>
          {invalid && (
            <FailedMessage
              onClose={() => {
                setInvalid(false);
          ...
          <button
            type="submit"
            className="py-3 mt-3 rounded-md border border-white text-white  bg-button w-full"
          >
            Sign in
          </button>
          ...
          <a
            href={FACEBOOK_URL}
            className="flex justify-center py-3 rounded-md border mt-4  text-white  bg-color2"
          >
            <img
              src={facebookLogo}
              alt="facebook"
