    ...
    <MainLayout>
      <div className="flex justify-center mt-10 text-black">
        <form
          ...
          className="p-[30px] bg-primary w-full max-w-[400px] rounded-lg shadow-md shadow-"
        >
          <h2 className="text-center font-semibold text-3xl mb-3">Sign Up</h2>
          {status === "SUCCESS" && (
          ...
          <button
            type="submit"
            className="py-3 mt-3 rounded-md border border-secondary text-black bg-button w-full"
          >
            Register
          </button>
